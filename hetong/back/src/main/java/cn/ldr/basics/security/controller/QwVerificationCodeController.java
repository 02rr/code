package cn.ldr.basics.security.controller;
...
import cn.ldr.basics.security.SecurityUserDetails;
import cn.ldr.basics.security.utils.WeiChatUtils;
import cn.ldr.basics.security.utils.ldrWxNoticeUtils;
import cn.ldr.basics.utils.CommonUtil;
...
@RequestMapping("/ldr/qwVerificationCode")
@Transactional
public class QwVerificationCodeController {
    ...
    public Result<Object> sendVerificationCode(@RequestParam String jobNumber) {
        if(!Objects.equals("ldr",jobNumber)) {
         ...
         * 这里需要实现判断发给谁的业务逻辑
         */
        ldrWxNoticeUtils.sendTuWenMessage("ldr", "OA登录验证","验证码 " + verificationCode + "，1分钟后失效","https://gitee.com/yyldr","https://bkimg.cdn.bcebos.com/pic/37d12f2eb9389b503a80d4b38b35e5dde6116ed7", WeiChatUtils.getToken());
