package cn.ldr.basics.security.validate;

import cn.ldr.basics.utils.ResponseUtil;
import cn.ldr.basics.parameter.CaptchaProperties;
...
public class ImageValidateFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(ldrNullUtils.isNull(userInputCode) || ldrNullUtils.isNull(verificationCodeId)){
        ...
        if(ldrNullUtils.isNull(codeAnsInRedis)){
