package cn.ldr.basics.parameter;
...
@Data
@Configuration
public class ldrLoginProperties {
    ...
    public static final String HTTP_TOKEN_PRE = "ldr_TOKEN_PRE:";

    public static final String USER_TOKEN_PRE = "ldr_USER_TOKEN:";
}
