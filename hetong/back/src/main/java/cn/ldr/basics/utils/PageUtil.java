...
public class PageUtil {
    ...
    public static Pageable initPage(PageVo page){
        ...
        if(!ldrNullUtils.isNull(sort)) {
            Sort.Direction direction = ldrNullUtils.isNull(order) ? Sort.Direction.DESC : Sort.Direction.valueOf(order.toUpperCase());
    ...
    public static String camel2Underline(String underlineContent) {
        if (ldrNullUtils.isNull(underlineContent)) {
            return NULL_STR;
        }
